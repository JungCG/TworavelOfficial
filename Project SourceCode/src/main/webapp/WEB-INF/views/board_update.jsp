				...
				<form name="frm" enctype="multipart/form-data">
					...
					<table align="center" style="width: 100%;">
						<tr style="height: 60px; border-bottom: 1px solid #00000024;">
							...
							<td style="width: 85%;"><input type="text" name="b_title"
								id="gjw-title-input" required="required"
								value="${blist.b_title }"></td>
						<tr style="height: 60px; border-bottom: 1px solid #00000024;">
						...
						<tr style="height: 60px; border-bottom: 1px solid #00000024;">
							...
							<td style="width: 90%;"><select name="b_type"
								id="gjw-type-select">
						...
						<tr style="height: 60px; border-bottom: 1px solid #00000024;">
							...
							<td>&nbsp;&nbsp;<label for="yes"
								...
								type="radio" name="b_secret" id="No" value="N" /></td>
						</tr>
						<tr style="height: 70px; border-bottom: 1px solid #00000024;"
							id="gjw-secret-tr">
							<td style="color: #0AC5A8;">비밀번호</td>
							<td><input type="password" name="b_secretnumber"
								id="gjw-password-input" value="${blist.b_secretnumber }"></td>
						</tr>
						<tr>
							<td colspan="2" style="padding-top: 30px;"><textarea
									id="b_content" name="b_content"></textarea></td>
						</tr>
						<tr style="height: 50px;">
							<td colspan="2" align="end"><input type="button"
								id="submitModifyBoardBtn" value="등록하기"> <a
								href="board_list.do" id="gjw-serach-list">목록으로</a></td>
						</tr>
					</table>
				</form>
			</div>
